...
use GKR_MSM::polynomial::vecvec::VecVecPolynomial;
...
mod maps {
    ...
    use GKR_MSM::polynomial::vecvec::{vecvec_map, VecVecPolynomial};
    use GKR_MSM::utils::{MapSplit, TwistedEdwardsConfig};
    ...
    pub fn vecvec<F: PrimeField + TwistedEdwardsConfig>(polys: &[VecVecPolynomial<F>]) -> Vec<VecVecPolynomial<F>> {
        vecvec_map(polys, twisted_edwards_add_l3())
    }
}
